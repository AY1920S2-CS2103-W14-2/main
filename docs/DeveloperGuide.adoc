= InventoryManager v1.1 - Developer Guide
...
** Pros: Less memory is used (e.g. for add command -- remember the object added).
** Cons: Must ensure that the undo implementation for each individual command is correct.
