...
The current implementation of `buy` performs validation as follows:
...
since this can be extracted from the Supplier's offers under the hood.

** Cons: If user has making a new purchase, he or she has to first do data entry
