...
import cs2103_w14_2.inventory.logic.parser.FindTransactionCommandParser.TransactionType;
...
public class TransactionContainKeywordsPredicate implements Predicate<Transaction> {
    ...
    public TransactionContainKeywordsPredicate(TransactionType transactionType,
        ...
        CollectionUtil.requireAllNonNull(transactionType, supplierNameKeywords, goodNameKeywords);
