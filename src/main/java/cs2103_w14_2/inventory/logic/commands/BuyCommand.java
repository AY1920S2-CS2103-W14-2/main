...
public class BuyCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Buys goods from the supplier at the displayed index.\n"
            ...
            + "Parameters: "
            + CliSyntax.PREFIX_GOOD_NAME + "GOOD_NAME "
            + CliSyntax.PREFIX_QUANTITY + "QUANTITY "
            + "\nExample: " + COMMAND_WORD + " 2 "
            + CliSyntax.PREFIX_GOOD_NAME + "Apples "
    ...
    public BuyCommand(GoodName boughtGoodName, GoodQuantity boughGoodQuantity, Index supplierIndex) {
        CollectionUtil.requireAllNonNull(boughtGoodName, boughGoodQuantity, supplierIndex);
     ...
     * @return
     * @throws cs2103_w14_2.inventory.logic.commands.exceptions.CommandException
     */
    @Override
