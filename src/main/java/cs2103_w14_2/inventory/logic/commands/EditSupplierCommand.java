...
import static cs2103_w14_2.inventory.model.Model.PREDICATE_SHOW_ALL_SUPPLIERS;
...
public class EditSupplierCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the details of the supplier identified "
            ...
            + "[" + CliSyntax.PREFIX_OFFER + "GOOD_PRICE_PAIR]...\n"
            + "Example: " + COMMAND_WORD + " 1 "
            + CliSyntax.PREFIX_CONTACT + "63865586 "
            + CliSyntax.PREFIX_OFFER + "Watermelon 10";
