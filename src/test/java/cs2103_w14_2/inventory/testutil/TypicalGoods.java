...
public class TypicalGoods {
    ...
    public static final Good AVOCADO = new GoodBuilder().withGoodName(CommandTestUtil.VALID_GOOD_NAME_AVOCADO).build();
    public static final Good BLUEBERRY = new GoodBuilder().withGoodName(CommandTestUtil.VALID_GOOD_NAME_BLUEBERRY).build();
