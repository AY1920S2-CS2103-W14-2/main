...
public class EditSupplierDescriptorTest {
    ...
    public void equals() {
        ...
        EditSupplierCommand.EditSupplierDescriptor descriptorWithSameValues = new EditSupplierCommand.EditSupplierDescriptor(DESC_AMY);
        ...
        EditSupplierCommand.EditSupplierDescriptor editedAmy = new EditSupplierDescriptorBuilder(DESC_AMY)
