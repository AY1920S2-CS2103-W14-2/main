...
import cs2103_w14_2.inventory.model.good.GoodNameContainsKeywordsPredicate;
...
public class CommandTestUtil {
    ...
    public static final String PHONE_DESC_AMY = " " + CliSyntax.PREFIX_CONTACT + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + CliSyntax.PREFIX_CONTACT + VALID_PHONE_BOB;
    ...
    public static final String OFFER_DESC_APPLE = " " + CliSyntax.PREFIX_OFFER + VALID_OFFER_APPLE;
    public static final String OFFER_DESC_BANANA = " " + CliSyntax.PREFIX_OFFER + VALID_OFFER_BANANA;

    public static final String INVALID_NAME_DESC = " " + CliSyntax.PREFIX_NAME + "James&"; // '&' not allowed in names
    public static final String INVALID_PHONE_DESC = " " + CliSyntax.PREFIX_CONTACT + "911a"; // 'a' not allowed in phones
    ...
    // no space separator
    public static final String INVALID_FORMAT_OFFER_DESC = " " + CliSyntax.PREFIX_OFFER + "invalid3.45";
    //invalid good name
    public static final String INVALID_GOOD_OFFER_DESC = " " + CliSyntax.PREFIX_OFFER + "inv@lid 404";
    //invalid good name and price
    public static final String INVALID_GOOD_AND_PRICE_OFFER_DESC = " " + CliSyntax.PREFIX_OFFER + "inv@lid -404";
    //invalid good name and format
    public static final String INVALID_GOOD_AND_FORMAT_OFFER_DESC = " " + CliSyntax.PREFIX_OFFER + "inv@lid404";
    // invalid price
    public static final String INVALID_PRICE_OFFER_DESC = " " + CliSyntax.PREFIX_OFFER + "invalid -1.0";
    // invalid price and format
    public static final String INVALID_PRICE_AND_FORMAT_OFFER_DESC = " " + CliSyntax.PREFIX_OFFER + "invalid-1.0";
